...
#############################################################################
		...
		public function make_pdf($fdf_data_strings, $fdf_data_names, $fields_hidden, $fields_readonly, $pdf_original, $pdf_filename) {
			...
			if($fp) {
                ...
                //$passthu_command = "c:\\temp\\pdftk.exe $pdf_original fill_form \"$fdf_fn\" output - flatten";
//passthru($passthu_command);

//write variable to file this is for testing. Comment out for production.
//$myFile = "testFile.txt";
//$fh = fopen($myFile, 'w') or die("can't open file");
//fwrite($fh, $passthu_command);
//fclose($fh);
